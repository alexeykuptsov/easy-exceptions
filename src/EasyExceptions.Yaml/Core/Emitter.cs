...
using ParsingEvent = EasyExceptions.Yaml.Core.Events.ParsingEvent;
...
namespace EasyExceptions.Yaml.Core
{
    ...
    public class Emitter : IEmitter
    {
        ...
        private void EmitSequenceStart(ParsingEvent evt)
        {
            ...
            if (flowLevel != 0 || isCanonical || CheckEmptySequence())
            {
        ...
        private void EmitMappingStart(ParsingEvent evt)
        {
            ...
            if (flowLevel != 0 || isCanonical || CheckEmptyMapping())
            {
